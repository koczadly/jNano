...
public interface Configuration {
    ...
    public static final String  NODE_IP =               "127.0.0.1";
    public static final int     NODE_PORT =             7076;
    public static final String  TEST_ACCOUNT =          "xrb_365md53cciaquuerrp97psfrsg1bd4rw5d8cyfpyefgofsopiuzozibdnbmx";
    public static final String  TEST_WALLET =           "B4ECF585D887B590907949C41F73BB11AA0BD4FD98563CC5D810EF26FAAD948E";
